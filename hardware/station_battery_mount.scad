...
boss_d       = 7.0;    // діаметр бобишки (внутрішня)
...
// Позиції бобишок — внутрішні кутові колонки (центр врівень із зовнішньою стінкою,
// колонка виступає всередину порожнини, між елементами і стінкою)
boss_pos = [
